...
SEQUENCES = (
    ('bookbrainz.disambiguation_disambiguation_id_seq',
     'bookbrainz.disambiguation.disambiguation_id'),
    ('bookbrainz.edition_status_edition_status_id_seq',
     'bookbrainz.edition_status.edition_status_id'),
    ('musicbrainz.language_id_seq', 'musicbrainz.language.id'),
    ('bookbrainz.work_type_work_type_id_seq',
     'bookbrainz.work_type.work_type_id'),
    ('bookbrainz.entity_data_entity_data_id_seq',
     'bookbrainz.entity_data.entity_data_id'),
    ('bookbrainz.rel_type_relationship_type_id_seq',
     'bookbrainz.rel_type.relationship_type_id'),
    ('bookbrainz.annotation_annotation_id_seq',
     'bookbrainz.annotation.annotation_id'),
    ('bookbrainz.creator_type_creator_type_id_seq',
     'bookbrainz.creator_type.creator_type_id'),
    ('musicbrainz.gender_id_seq', 'musicbrainz.gender.id'),
    ('bookbrainz.user_type_user_type_id_seq', 'bookbrainz.user_type.user_type_id'),
    ('bookbrainz.publisher_type_publisher_type_id_seq',
     'bookbrainz.publisher_type.publisher_type_id'),
    ('bookbrainz.publication_type_publication_type_id_seq',
     'bookbrainz.publication_type.publication_type_id'),
    ('bookbrainz.user_user_id_seq', 'bookbrainz.user.user_id'),
    ('bookbrainz.alias_alias_id_seq', 'bookbrainz.alias.alias_id'),
    ('bookbrainz.rel_data_relationship_data_id_seq', 'bookbrainz.rel_data.relationship_data_id'),
    ('bookbrainz.revision_revision_id_seq', 'bookbrainz.revision.revision_id'),
    ('bookbrainz.message_message_id_seq', 'bookbrainz.message.message_id'),
    ('bookbrainz.rel_relationship_id_seq', 'bookbrainz.rel.relationship_id'),
    ('bookbrainz.revision_note_revision_note_id_seq',
