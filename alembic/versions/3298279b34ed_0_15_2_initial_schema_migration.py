...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime, server_default=sa.text(u'now()'), nullable=False),
    sa.Column('active_at', sa.DateTime, server_default=sa.text(u'now()'), nullable=False),
    ...
    sa.Column('edit_id', sa.Integer(), nullable=False),
    sa.Column('content', sa.UnicodeText(), nullable=False),
    sa.Column('posted_at', sa.DateTime, server_default=sa.text(u'now()'), nullable=False),
    sa.ForeignKeyConstraint(['edit_id'], ['bookbrainz.edit.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['bookbrainz.user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='bookbrainz'
    ...
    op.create_foreign_key('fk_master_revision_id', 'entity', 'entity_revision', ['master_revision_id'], ['id'], source_schema='bookbrainz', referent_schema='bookbrainz')
